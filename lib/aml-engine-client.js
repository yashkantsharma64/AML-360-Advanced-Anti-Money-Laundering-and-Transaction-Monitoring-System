...
export class RiskScoringEngine {
  ...
  async checkStructuringPattern(transaction) {
    try {
      ...
      const isInRange = transaction.amount_usd >= 8000 && transaction.amount_usd <= 9999;
      
      return {
        detected: isInRange, // Simplified for client-side
        threeDaySum: isInRange ? transaction.amount_usd : 0,
        count: isInRange ? 1 : 0,
