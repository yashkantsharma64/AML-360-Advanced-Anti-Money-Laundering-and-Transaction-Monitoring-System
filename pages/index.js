...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>AML Transaction Monitoring System</title>
        <meta name="description" content="Real-time AML transaction monitoring and risk scoring" />
      </Head>
        ...
        <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">AML 360</h1>
                <p className="text-gray-600 dark:text-gray-300">Suspicious Transaction Monitoring & Risk Scoring</p>
              </div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {loading ? (
            <div className="flex justify-center items-center py-12">
              ...
              <span className="ml-3 text-lg text-gray-600 dark:text-gray-300">Loading stats...</span>
            </div>
          ) : (
            <>
              {/* Stats Cards */}
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow dark:shadow-gray-700">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow dark:shadow-gray-700">
                      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Manual Transaction Entry</h2>
                      <p className="text-gray-600 dark:text-gray-300 mb-6">Enter transaction details manually for real-time risk assessment.</p>
                      <Link href="/form" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow dark:shadow-gray-700">
                      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">CSV Upload</h2>
                      <p className="text-gray-600 dark:text-gray-300 mb-6">Upload a CSV file with multiple transactions for batch processing.</p>
                      <Link href="/upload" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 transition-colors">
                        <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-gray-700">
                    <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                      <div className="flex justify-between items-center">
                        ...
                        <Link href="/transactions" className="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                          View All →
                        </Link>
                      </div>
                    </div>
                    <div className="p-6">
                      {recentTransactions.length === 0 ? (
                        <p className="text-gray-500 dark:text-gray-400 text-center py-8">
                          No transactions yet. <Link href="/form" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Add your first transaction</Link> to get started.
                        </p>
                      ) : (
                        <div className="space-y-4">
                          {recentTransactions.map((transaction) => (
                            <div key={transaction._id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
